  ...
  <div>
    <div className = {style.wrap}>
      <div className = {style.top}>
        <h3 className = {style.toph3}>비상 시 지켜야할 기본 행동요령</h3>
        <p>집밖으로 나오지 말고 방송을 계속 들으면서 정부의 안내를 믿고 따라야 합니다. 무작정 피난에 나서거나 식량·연료 등 생활필수품의 사재기를 해서는 안되며, 정부가 배급제를 실시할 경우 적극협조해야 합니다.</p>
      ...
      <Carousel.Item>
        <img/>
        <h1 className ={style.h1}>1. 경보가 울리면 어떻게 해야 하는가?</h1>
        <h3>경보가 울리면 즉시 방송을 들으며 정부의 안내에 따라야 합니다. 밤에는 불을 꺼야하며 부득이한 경우에는 불빛이 밖으로 새어 나가지 않도록 차단해야 합니다.</h3>
        <Carousel.Caption>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <h1 className ={style.h1}>2. 경계경보가 울리면 대피할 준비를 해야 합니다</h1>
      ...
      <Carousel.Item>
        <img/>
        <h1 className ={style.h1}>3. 공습경보가 울리면 즉시 대피해야 합니다</h1>
